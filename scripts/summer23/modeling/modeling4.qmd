...
fit1_we <- cfa(m, data = df_we, 
            std.lv = T, group = "Sex")
fit2_we <- cfa(m, data = df_we, group = "Sex",
            group.equal = "loadings")
fit3_we <- cfa(m, data = df_we, group = "Sex",
...
```{r}
# fit the model (group by gender)
fit1_nwe <- cfa(m, data = df_nwe, 
            std.lv = T, group = "Sex")
fit2_nwe <- cfa(m, data = df_nwe, group = "Sex",
            group.equal = "loadings")
fit3_nwe <- cfa(m, data = df_nwe, group = "Sex",
            group.equal = c("intercepts", "loadings"))
# display summary
...
# worked ex data
## Chicago
df_we$chicago <- as.factor(df_we$chicago)
...
```{r}
# fit the model (group by gender)
fit1_we_c <- cfa(m, data = df_we_c, 
            std.lv = T, group = "Sex")
fit2_we_c <- cfa(m, data = df_we_c, group = "Sex",
            group.equal = "loadings")
fit3_we_c <- cfa(m, data = df_we_c, group = "Sex",
            group.equal = c("intercepts", "loadings"))
# display summary
...
```{r}
# fit the model (group by gender)
fit1_we_i <- cfa(m, data = df_we_i, 
            std.lv = T, group = "Sex")
fit2_we_i <- cfa(m, data = df_we_i, group = "Sex",
            group.equal = "loadings")
fit3_we_i <- cfa(m, data = df_we_i, group = "Sex",
            group.equal = c("intercepts", "loadings"))
# display summary
...
```{r}
# fit the model (group by gender)
fit1_nwe_c <- cfa(m, data = df_nwe_c, 
            std.lv = T, group = "Sex")
fit2_nwe_c <- cfa(m, data = df_nwe_c, group = "Sex",
            group.equal = "loadings")
fit3_nwe_c <- cfa(m, data = df_nwe_c, group = "Sex",
            group.equal = c("intercepts", "loadings"))
# display summary
...
```{r}
# fit the model (group by gender)
fit1_nwe_i <- cfa(m, data = df_nwe_i, 
            std.lv = T, group = "Sex")
fit2_nwe_i <- cfa(m, data = df_nwe_i, group = "Sex",
            group.equal = "loadings")
fit3_nwe_i <- cfa(m, data = df_nwe_i, group = "Sex",
            group.equal = c("intercepts", "loadings"))
# display summary
