...
No missing data in TMA, but some data were missing in MW and SI
- 7 missing data from at least each MW score from day 1
...
Data imputation is required for following variables: `MW1_1`, `MW1_2`, `MW1_3` ,`MW1_4` ,`MW1_5` ,`MW1_6`,`MW1_7`,
`MW2_5`, `SI_6`, `Understand_avg`
...
```{r}
# mind wandering
df3 %>% select(Condition, Sex, chicago, TMA,
               contains("MW1")) %>% 
   filter_all(any_vars(is.na(.)))
