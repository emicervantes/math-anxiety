...
**Summary**: Irvine schools had higher pretest scores than Chicago, which 
indicate that more students from Irvine knew how to approach ratio problem at the 
start of the experiment than the students from Chicago. On the other hand, there
was not that much of a difference in pretest scores between girls an boys. Now,
we look at the pretest score in the worked example group vs no worked example group.
