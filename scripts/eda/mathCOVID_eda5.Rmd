...
acc_avg_plt <- df %>% 
  ...
  scale_fill_manual(values = c("#ef476f","#1b9aaa"), labels = 
                                  c("No Worked EX", "Worked EX")) +
  labs(x = "Condition", y = "Overall Accuracy", title = "Average Overall Accuracy Scores") + theme(legend.position = "none") + ylim(0,1)
...
tma_avg_plt <- df %>% 
  ...
  scale_fill_manual(values = c("#ef476f","#1b9aaa"), labels = 
                                  c("No Worked EX", "Worked EX")) +
  labs(x = "Condition", y = "TMA", title = "Average Math Anxiety Scores")+ theme(legend.position = "none") + ylim(0,5)
```
